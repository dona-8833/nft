...
function NftCard() {
  return (
    ...
    >
      ...
      {/* Left Card */}
      <div className="md:-rotate-20 -rotate-10 left-20 md:left-10  transition-transform duration-300 flex flex-col gap-2 items-center p-3 md:p-4 rounded-xl bg-info/50  backdrop-blur-md  border border-primary/30 w-57 relative z-10">
        {/* Avatar + Info */}
      ...
      {/* Middle Card */}
      <div className=" transition-transform duration-300 flex flex-col gap-2 items-center p-3 md:p-4 rounded-xl bg-info/50 backdrop-blur-md border border-primary/30 w-57 relative z-10">
        <div className="flex items-center gap-2 justify-start w-full">
          <div className="rounded-full overflow-hidden h-10 w-10 border border-white/20">
            <img
              src="/pepeKing.jpg"
      ...
      {/* Right Card */}
      <div className="md:rotate-20 rotate-10 right-20 md:right-10 z-0 transition-transform duration-300 flex flex-col gap-2 items-center p-3 md:p-4 rounded-xl bg-info/50 backdrop-blur-md border border-primary/30 w-57 relative ">
        <div className="flex items-center gap-2 justify-start w-full">
          <div className="rounded-full overflow-hidden h-10 w-10 border border-white/20">
            <img
              src="/pepeKing.jpg"
