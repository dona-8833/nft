  ...
  return (
    <><div className="relative">
      ...
      <div className="px-4 relative max-w-full overflow-x-hidden">
        <p className="text-sm text-center text-gray-200 font-light">
      ...
      <div className=" flex flex-col gap-8 md:gap-0 mt-20   md:mx-20 ">
        <div className="flex items-center  gap-30 justify-between flex-col md:flex-row">
          <div className="border border-secondary/40 rounded-4xl p-4 flex flex-col items-center justify-center">
        ...
        <div className="md:relative md:my-30  flex flex-col md:flex-row justify-between items-center">
          <img
            src="/bunny.png"
        ...
        <div className="flex items-center gap-30 justify-between flex-col-reverse md:flex-row">
          <div className="border border-secondary/40 rounded-4xl p-4 flex flex-col items-center justify-center">
            <div className="bg-gradient-to-b w-fit rounded-full p-1 from-primary to-secondary">
